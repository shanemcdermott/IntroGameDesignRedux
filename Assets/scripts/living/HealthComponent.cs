...
public class HealthComponent : MonoBehaviour, IRespondsToDeath
{
	...
	//Array of components that need to do something when the object takes damage
	protected List<IRespondsToDamage> damageResponders = new List<IRespondsToDamage>();
	...
	public void RegisterDamageResponder(IRespondsToDamage damageResponder)
	{
		damageResponders.Add (damageResponder);
	}
